...
All 64 public, indexable HTML pages have page-specific search titles, descriptions, focused keyword tags, Open Graph tags, Twitter preview tags and canonical URLs. Account, redirect and error pages keep their existing noindex settings.
