...
const content=`<div class="breadcrumbs"><a href="/docs/">Documentation</a> / Left 4 Dead</div><h1>Left 4 Dead Lua API</h1><p class="article-intro">L4D1 &amp; L4D2 · Host API 1.0 · UI API 1.0</p><div class="wiki-note"><p>Use these APIs from the Scooby Lua editor. Each snippet runs independently. Game data is available in an allowed local <code>-insecure</code> session; nil and empty results are expected while loading. <a href="/guides/l4d/getting-started/">Setup guide →</a></p></div><nav class="lua-section-links" aria-label="API sections">${sources.map(([id,title])=>`<a href="#${id}">${title}</a>`).join('')}</nav>${sections}`;
